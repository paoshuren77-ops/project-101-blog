...
export const fallbackPosts: BlogPost[] = [
  {
    ...
    content:
      "组件的可维护性来自清晰边界。把数据获取、交互状态和展示结构拆开，能让未来的需求变化更容易落地。\n\n命名也很重要。好的命名能把组件承担的职责说清楚，减少阅读者的猜测成本。",
    topic: "工程",
    author: "陈序",
    tags: ["前端", "工程", "React"],
    coverImage:
  ...
  },
  {
    ...
    content:
      "城市漫游不需要排满清单。选一条街区，把书店、咖啡馆和菜市场串起来，通常比地标打卡更接近真实生活。",
    topic: "生活",
    author: "苏禾",
    tags: ["生活", "城市", "摄影"],
    coverImage:
  ...
  },
  {
    ...
    content:
      "决策记录不是为了制造文档负担，而是为了保存团队判断的上下文。它回答三个问题：当时为什么这样选，放弃了什么，未来什么时候应该重新评估。",
    topic: "团队",
    author: "许安",
    tags: ["管理", "团队", "文档"],
    coverImage:
  ...
  },
  {
    ...
    content:
      "阅读的目标不是囤积摘录，而是把注意力重新组织到重要问题上。真正有用的笔记，应该能在需要做判断时被再次调用。",
    topic: "阅读",
    author: "林墨",
    tags: ["阅读", "方法", "思考"],
    coverImage:
